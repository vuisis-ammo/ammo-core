 ...
 * 
 */
public class AmmoCoreCursorAdapter extends ActivityEx {
    ...
    private ChannelCursorAdapter channelAdapter = null;
    ...
    private ServiceConnection networkServiceConnection = new ServiceConnection() {
        final private AmmoCoreCursorAdapter parent = AmmoCoreCursorAdapter.this; 
...
/*            oneALIgateway = new AmmoListItem(currentCursor.getString(0), 
                    currentCursor.getString(1), currentCursor.getString(2), currentCursor.getString(3));
            currentCursor.moveToNext();
            twoALIserial = new AmmoListItem(currentCursor.getString(0), 
                    currentCursor.getString(1), currentCursor.getString(2), currentCursor.getString(3));
            currentCursor.moveToNext();
            threeALImulticast = new AmmoListItem(currentCursor.getString(0), 
                    currentCursor.getString(1), currentCursor.getString(2), currentCursor.getString(3));
            currentCursor.moveToNext();
            fourALIrmulticast = new AmmoListItem(currentCursor.getString(0), 
                    currentCursor.getString(1), currentCursor.getString(2), currentCursor.getString(3));*/
...
/*            channelModel.clear();
            ...
            String[] cols = {"Name","FormalIP","Port","Election"};
            int[] viewIds = new int[] { R.id.multicast_name, R.id.multicast_formal, R.id.multicast_status_one, R.id.multicast_status_two };
            channelAdapter = new ChannelCursorAdapter(this, currentCursor, R.layout.multicast_item, cols, viewIds);
            channelAdapter.notifyDataSetChanged();
            //channelList.setAdapter(channelAdapter);
            SimpleCursorAdapter tempAdapter = new SimpleCursorAdapter(this, R.layout.multicast_item, currentCursor,cols, viewIds);
            channelList.setAdapter(tempAdapter);
        } else {
        ...
        /*currentCursor.registerContentObserver(new ContentObserver(handler){
             ...
             public void onChange(boolean selfChange) {
                 ...
                 oneALI.update(tempcursor.getString(0), 
                         tempcursor.getString(1), tempcursor.getString(2), tempcursor.getString(3));
                 tempcursor.moveToNext();
                 
                 twoALI.update(tempcursor.getString(0), 
                         tempcursor.getString(1), tempcursor.getString(2), tempcursor.getString(3));
                 tempcursor.moveToNext();
        ...
        channelList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (selectedChannel.getName().contains("Gateway")) {
                    intent.setClass(AmmoCoreCursorAdapter.this, GatewayPreferences.class);
                } else if (selectedChannel.getName().contains("Serial")) {
                    intent.setClass(AmmoCoreCursorAdapter.this, SerialPreferences.class);
                } else if (selectedChannel.getName().contains("Reliable")) {
                    intent.setClass(AmmoCoreCursorAdapter.this, ReliableMulticastPreferences.class);
                } else if (selectedChannel.getName().contains("Multicast")) {
                    intent.setClass(AmmoCoreCursorAdapter.this, MulticastPreferences.class);
                } else {
                    Toast.makeText(AmmoCoreCursorAdapter.this, "Did not recognize channel",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                AmmoCoreCursorAdapter.this.startActivity(intent);
            }
        });
    }

    //I am pretty sure this method is non-functional -ML
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                case DialogInterface.BUTTON_POSITIVE:
                    ...
                    intent.setClass(AmmoCoreCursorAdapter.this, AmmoService.class);
                    startService(intent);
                    break;
