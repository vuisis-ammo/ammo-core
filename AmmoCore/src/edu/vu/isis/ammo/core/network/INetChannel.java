...
public interface INetChannel {
	...
	static public final int LINK_ACTIVE     = 33; // indicating the underlying link is down -- unused
	...
	static public final int SHUTDOWN        = 51; // the run is being stopped -- unused
