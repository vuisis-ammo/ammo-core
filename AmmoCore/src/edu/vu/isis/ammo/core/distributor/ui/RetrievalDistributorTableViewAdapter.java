 ...
 */
public class RetrievalDistributorTableViewAdapter extends DistributorTableViewAdapter
{
	public static final Logger logger = LoggerFactory.getLogger(RetrievalDistributorTableViewAdapter.class);
	...
	public RetrievalDistributorTableViewAdapter(Context context, int layout, Cursor cursor,
			String[] from, int[] to) 
	{
	...
	public void bindView(View v, Context context, Cursor cursor) {
		...
		tttv.setText(cursor.getString(cursor.getColumnIndex(SubscribeTableSchema.TOPIC.n)));
