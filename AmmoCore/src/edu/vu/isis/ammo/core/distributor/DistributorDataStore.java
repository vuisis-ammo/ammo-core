...
public class DistributorDataStore {
    ...
    static {
        ...
        POSTAL_STATUS_QUERY = new StringBuilder()
                ...
                .append(" ON d.").append(DisposalTableSchema.CHANNEL.q()).append("=c.")
                .append(ChannelTableSchema.NAME.q())
                .append(" WHERE p.").append(PostalTableSchema._ID.q()).append("=d.")
                .append(DisposalTableSchema.PARENT.q())
                .append("   AND d.").append(DisposalTableSchema.TYPE.q()).append('=')
                .append(rel_postal.qv())
                .append("   AND c.").append(ChannelTableSchema.STATE.q()).append('=')
                .append(ChannelState.ACTIVE.q())
    ...
    static {
        ...
        RETRIEVAL_STATUS_QUERY = new StringBuilder()
                ...
                .append(" ON d.").append(DisposalTableSchema.CHANNEL.q()).append("=c.")
                .append(ChannelTableSchema.NAME.q())
                .append(" WHERE p.").append(RetrievalTableSchema._ID.q()).append("=d.")
                .append(DisposalTableSchema.PARENT.q())
                .append("   AND d.").append(DisposalTableSchema.TYPE.q()).append("=")
                .append(rel_retrieval.qv())
                .append("   AND c.").append(ChannelTableSchema.STATE.q()).append('=')
                .append(ChannelState.ACTIVE.q())
                .append("   AND d.").append(DisposalTableSchema.STATE.q())
                .append(" IN (")
    ...
    static {
        ...
        SUBSCRIBE_STATUS_QUERY = new StringBuilder()
                ...
                .append(" ON d.").append(DisposalTableSchema.CHANNEL.q()).append("=c.")
                .append(ChannelTableSchema.NAME.q())
                .append(" WHERE p.").append(SubscribeTableSchema._ID.q()).append("=d.")
                .append(DisposalTableSchema.PARENT.q())
                .append("   AND d.").append(DisposalTableSchema.TYPE.q()).append("=")
                .append(rel_subscribe.qv())
                .append("   AND c.").append(ChannelTableSchema.STATE.q()).append('=')
                .append(ChannelState.ACTIVE.q())
                .append("   AND d.").append(DisposalTableSchema.STATE.q())
                .append(" IN (")
    ...
    public synchronized long upsertSubscribe(ContentValues cv, Dispersal status) {
        try {
            ...
            for (Entry<String, DisposalState> entry : status.entrySet()) {
                this.upsertDisposalByParent(Relations.SUBSCRIBE, key, entry.getKey(),
                        entry.getValue());
            }
            return key;
        } catch (IllegalArgumentException ex) {
    ...
    private synchronized long upsertDisposalByParent(Relations type, long id, String channel,
        ...
        try {
            ...
            cv.put(DisposalTableSchema.STATE.cv(), (status == null) ? DisposalState.PENDING.o
                    : status.o);

            final int updateCount = this.db.update(Relations.DISPOSAL.n, cv,
                    DISPOSAL_UPDATE_CLAUSE, new String[] {
                            typeVal, String.valueOf(id), channel
                    });
            if (updateCount > 0) {
                final Cursor cursor = this.db.query(Relations.DISPOSAL.n, new String[] {
                        DisposalTableSchema._ID.n
                },
                        DISPOSAL_UPDATE_CLAUSE, new String[] {
                                typeVal, String.valueOf(id), channel
                        },
    ...
    public synchronized long upsertChannelByName(String channel, ChannelState status) {
        try {
            ...
            final int updateCount = this.db.update(Relations.CHANNEL.n, cv,
                    CHANNEL_UPDATE_CLAUSE, new String[] {
                        channel
                    });
            if (updateCount > 0)
                return 0;
    ...
    public synchronized int deactivateDisposalStateByChannel(String channel) {
        try {
            return this.db.update(Relations.DISPOSAL.n, DISPOSAL_PENDING_VALUES,
                    DISPOSAL_DEACTIVATE_CLAUSE, new String[] {
                        channel
                    });
        } catch (IllegalArgumentException ex) {
    ...
    public synchronized int repairDisposalStateByChannel(String channel) {
        try {
            return this.db.update(Relations.DISPOSAL.n, DISPOSAL_PENDING_VALUES,
                    DISPOSAL_REPAIR_CLAUSE, new String[] {
                        channel
                    });
        } catch (IllegalArgumentException ex) {
    ...
    public synchronized long updatePostalByKey(long id, ContentValues cv, Dispersal state) {
        ...
        try {
            return this.db.update(Relations.POSTAL.n, cv, "\"_id\"=?", new String[] {
                    String.valueOf(id)
            });
        } catch (IllegalArgumentException ex) {
    ...
    public synchronized long updateRetrievalByKey(long id, ContentValues cv, final Dispersal state) {
        ...
        try {
            ...
            return this.db.update(Relations.RETRIEVAL.n, cv, "\"_id\"=?", new String[] {
                    String.valueOf(id)
            });
        } catch (IllegalArgumentException ex) {
    ...
    public synchronized long updateSubscribeByKey(long id, ContentValues cv, final Dispersal state) {
        ...
        try {
            return this.db.update(Relations.SUBSCRIBE.n, cv, "\"_id\"=?", new String[] {
                    String.valueOf(id)
            });
        } catch (IllegalArgumentException ex) {
    ...
    static {
        ...
        DISPOSAL_RETRIEVAL_ORPHAN_CONDITION = new StringBuilder()
                ...
                .append(" WHERE ").append(DisposalTableSchema.PARENT.q())
                .append('=').append(rel_retrieval.q()).append(".")
                .append(RetrievalTableSchema._ID.q())
                .append(')')
                .toString();
    }
    ...
    public synchronized int purgeRetrieval() {
        try {
            ...
            db.delete(Relations.DISPOSAL.n, DISPOSAL_PURGE,
                    new String[] {
                        new RelationsHelper(Relations.RETRIEVAL).qv()
                    });
    ...
    static {
        ...
        DISPOSAL_SUBSCRIBE_ORPHAN_CONDITION = new StringBuilder()
                ...
                .append(" WHERE ").append(DisposalTableSchema.PARENT.q())
                .append('=').append(rel_subscribe.q()).append(".")
                .append(SubscribeTableSchema._ID.q())
                .append(')')
                .toString();
    }
    ...
    public synchronized int purgeSubscribe() {
        try {
            ...
            db.delete(Relations.DISPOSAL.n, DISPOSAL_PURGE,
                    new String[] {
                        new RelationsHelper(Relations.SUBSCRIBE).qv()
                    });
