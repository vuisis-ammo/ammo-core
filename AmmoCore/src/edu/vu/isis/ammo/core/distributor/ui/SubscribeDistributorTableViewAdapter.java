 ...
 *
 */
public class SubscribeDistributorTableViewAdapter extends DistributorTableViewAdapter
{
	public static final Logger logger = LoggerFactory.getLogger(SubscribeDistributorTableViewAdapter.class);
	...
	public SubscribeDistributorTableViewAdapter(Context context, int layout, Cursor cursor,
			String[] from, int[] to) 
	{
	...
	public void bindView(View v, Context context, Cursor cursor) {
		...
		tttv.setText(cursor.getString(cursor.getColumnIndex(SubscribeTableSchema.DATA_TYPE.n)));
