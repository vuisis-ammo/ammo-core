...
public class RequestSerializerComponentTest extends AndroidTestCase {
    ...
    /**
     * ====================================================================
     * These tests focus on the Request Serializer objects as components. Namely
     * how the parts interact with the differing content.
     * =====================================================================
     */
    ...
    // TODO: more tests
    /*
     * public void testRoundTripJson_table3_basic() { SchemaTable3Data d = new
     * SchemaTable3Data(); ContentValues cv = d.createContentValues();
     * this.roundTripTrial(Encoding.newInstance(Encoding.Type.JSON), cv,
     * d.getTable(), d ); } public void testRoundTripJson_table3_random() { //
     * ... } // JSON public void testRoundTripJson_table3_basic_withBlob() {}
     * public void testRoundTripJson_table3_basic_withFile() {} public void
     * testRoundTripJson_table3_random_withBlob() {} public void
     * testRoundTripJson_table3_random_withFile() {} // Terse public void
     * testRoundTripTerse_table2_basic() {} public void
     * testRoundTripTerse_table3_basic() {} public void
     * testRoundTripTerse_table1_random() {} public void
     * testRoundTripTerse_table2_random() {} public void
     * testRoundTripTerse_table3_random() {}
     */
            ...
            final byte[] encodedBytes)
    {
        ...
        final AsyncQueryHelper.InsertResultHandler aqh = new AsyncQueryHelper.InsertResultHandler() {
            ...
            public void run() {
                ...
                d.compareJsonToUri(encodedBytes, provider, resultTuple);
            }
